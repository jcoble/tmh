...
class Appointments implements IConvertible
{
    ...
    Appointments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.apptDateTime,this.place,this.placeNotes,this.providerName,this.appUserAuthId});
    Appointments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CrudEvent implements IConvertible
{
    ...
    CrudEvent({this.id,this.eventType,this.model,this.modelId,this.eventDate,this.rowsUpdated,this.requestType,this.requestBody,this.userAuthId,this.userAuthName,this.remoteIp,this.urn,this.refId,this.refIdStr,this.meta});
    CrudEvent.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class MeasurementDetails implements IConvertible
{
    ...
    MeasurementDetails({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.treatmentId,this.treatmentName,this.measurementTypeId,this.measurementTypeName,this.unitId,this.customerNotes,this.name});
    MeasurementDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class Measurements implements IConvertible
{
    ...
    Measurements({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentId,this.treatmentType});
    Measurements.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class MeasurementTypes implements IConvertible
{
    ...
    MeasurementTypes({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentTypeId});
    MeasurementTypes.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class Schedules implements IConvertible
{
    ...
    Schedules({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.scheduleTime,this.startDate,this.endDate,this.treatmentId,this.treatmentName,this.isWeekendDifferent,this.appointmentId,this.treatmentUserId,this.lastRunTime,this.lastRunStatus,this.nextRunDateTime});
    Schedules.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class TreatmentReminderSounds implements IConvertible
{
    ...
    TreatmentReminderSounds.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class Treatments implements IConvertible
{
    ...
    Treatments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentType,this.appUserAuthId,this.unitsId,this.treatmentReminderSoundId,this.isMuted,this.dailyFrequency,this.measurementTypesId,this.measurementTypesName,this.unitsPlanned});
    Treatments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class TreatmentScheduledEvents implements IConvertible
{
    ...
    TreatmentScheduledEvents({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.mood,this.scheduleId,this.treatmentId,this.treatmentName,this.treatmentUserId,this.treatmentUserName,this.treatmentDescription,this.completed,this.treatmentType,this.measurementTypeName,this.measurementId,this.measurementName,this.unitsPlanned,this.unitsTaken,this.unitTypesId,this.unitsTypeName,this.dateTimeEventPlanned,this.dateTimeUserConfirmedEvent,this.dateTimeSkippedEvent,this.customerNotes});
    TreatmentScheduledEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UserAuthRole implements IConvertible
{
    ...
    UserAuthRole({this.id,this.userAuthId,this.role,this.permission,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    UserAuthRole.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryAppointments extends QueryDb<Appointments> implements IReturn<QueryResponse<Appointments>>, IGet, IConvertible
{
    String? id;

    QueryAppointments({this.id});
    QueryAppointments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryAppUsers extends QueryDb<AppUser> implements IReturn<QueryResponse<AppUser>>, IGet, IConvertible
{
    ...
    QueryAppUsers.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryCrudEvents extends QueryDb<CrudEvent> implements IReturn<QueryResponse<CrudEvent>>, IGet, IConvertible
{
    ...
    QueryCrudEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryMeasurementDetails extends QueryDb<MeasurementDetails> implements IReturn<QueryResponse<MeasurementDetails>>, IGet, IConvertible
{
    String? id;

    QueryMeasurementDetails({this.id});
    QueryMeasurementDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryMeasurements extends QueryDb<Measurements> implements IReturn<QueryResponse<Measurements>>, IGet, IConvertible
{
    String? id;

    QueryMeasurements({this.id});
    QueryMeasurements.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryMeasurementTypes extends QueryDb<MeasurementTypes> implements IReturn<QueryResponse<MeasurementTypes>>, IGet, IConvertible
{
    String? id;

    QueryMeasurementTypes({this.id});
    QueryMeasurementTypes.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QuerySchedules extends QueryDb<Schedules> implements IReturn<QueryResponse<Schedules>>, IGet, IConvertible
{
    ...
    QuerySchedules.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryTreatmentReminderSounds extends QueryDb<TreatmentReminderSounds> implements IReturn<QueryResponse<TreatmentReminderSounds>>, IGet, IConvertible
{
    String? id;

    QueryTreatmentReminderSounds({this.id});
    QueryTreatmentReminderSounds.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryTreatments extends QueryDb<Treatments> implements IReturn<QueryResponse<Treatments>>, IGet, IConvertible
{
    ...
    QueryTreatments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryTreatmentScheduledEvents extends QueryDb<TreatmentScheduledEvents> implements IReturn<QueryResponse<TreatmentScheduledEvents>>, IGet, IConvertible
{
    String? id;

    QueryTreatmentScheduledEvents({this.id});
    QueryTreatmentScheduledEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryUserAuthDetails extends QueryDb<UserAuthDetails> implements IReturn<QueryResponse<UserAuthDetails>>, IGet, IConvertible
{
    int? id;

    QueryUserAuthDetails({this.id});
    QueryUserAuthDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class QueryUserAuthRoles extends QueryDb<UserAuthRole> implements IReturn<QueryResponse<UserAuthRole>>, IGet, IConvertible
{
    int? id;

    QueryUserAuthRoles({this.id});
    QueryUserAuthRoles.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateAppointments implements IReturn<IdResponse>, IPost, ICreateDb<Appointments>, IConvertible
{
    ...
    CreateAppointments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.apptDateTime,this.place,this.placeNotes,this.providerName,this.appUserAuthId});
    CreateAppointments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateAppUser implements IReturn<IdResponse>, IPost, ICreateDb<AppUser>, IConvertible
{
    ...
    CreateAppUser({this.profileUrl,this.lastLoginIp,this.lastLoginDate,this.userName,this.email,this.primaryEmail,this.phoneNumber,this.firstName,this.lastName,this.displayName,this.company,this.birthDate,this.birthDateRaw,this.address,this.address2,this.city,this.state,this.country,this.culture,this.fullName,this.gender,this.language,this.mailAddress,this.nickname,this.postalCode,this.timeZone,this.salt,this.passwordHash,this.digestHa1Hash,this.roles,this.permissions,this.createdDate,this.modifiedDate,this.invalidLoginAttempts,this.lastLoginAttempt,this.lockedDate,this.recoveryToken,this.refId,this.refIdStr,this.meta,this.appUserAuthId});
    CreateAppUser.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateCrudEvent implements IReturn<IdResponse>, IPost, ICreateDb<CrudEvent>, IConvertible
{
    ...
    CreateCrudEvent({this.eventType,this.model,this.modelId,this.eventDate,this.rowsUpdated,this.requestType,this.requestBody,this.userAuthId,this.userAuthName,this.remoteIp,this.urn,this.refId,this.refIdStr,this.meta});
    CreateCrudEvent.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateMeasurementDetails implements IReturn<IdResponse>, IPost, ICreateDb<MeasurementDetails>, IConvertible
{
    ...
    CreateMeasurementDetails({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.treatmentId,this.treatmentName,this.measurementTypeId,this.measurementTypeName,this.unitId,this.customerNotes,this.name});
    CreateMeasurementDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateMeasurements implements IReturn<IdResponse>, IPost, ICreateDb<Measurements>, IConvertible
{
    ...
    CreateMeasurements({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentId,this.treatmentType});
    CreateMeasurements.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateMeasurementTypes implements IReturn<IdResponse>, IPost, ICreateDb<MeasurementTypes>, IConvertible
{
    ...
    CreateMeasurementTypes({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentTypeId});
    CreateMeasurementTypes.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateSchedules implements IReturn<IdResponse>, IPost, ICreateDb<Schedules>, IConvertible
{
    ...
    CreateSchedules({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.scheduleTime,this.startDate,this.endDate,this.treatmentId,this.treatmentName,this.isWeekendDifferent,this.appointmentId,this.treatmentUserId,this.lastRunTime,this.lastRunStatus,this.nextRunDateTime});
    CreateSchedules.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateTreatmentReminderSounds implements IReturn<IdResponse>, IPost, ICreateDb<TreatmentReminderSounds>, IConvertible
{
    String? id;
    DateTime? createdAt;
    String? name;
    ...
    CreateTreatmentReminderSounds.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateTreatments implements IReturn<IdResponse>, IPost, ICreateDb<Treatments>, IConvertible
{
    ...
    CreateTreatments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentType,this.appUserAuthId,this.unitsId,this.treatmentReminderSoundId,this.isMuted,this.dailyFrequency,this.measurementTypesId,this.measurementTypesName,this.unitsPlanned});
    CreateTreatments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateTreatmentScheduledEvents implements IReturn<IdResponse>, IPost, ICreateDb<TreatmentScheduledEvents>, IConvertible
{
    String? id;
    DateTime? createdAt;
    DateTime? updatedAt;
    ...
    CreateTreatmentScheduledEvents({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.mood,this.scheduleId,this.treatmentId,this.treatmentName,this.treatmentUserId,this.treatmentUserName,this.treatmentDescription,this.completed,this.treatmentType,this.measurementTypeName,this.measurementId,this.measurementName,this.unitsPlanned,this.unitsTaken,this.unitTypesId,this.unitsTypeName,this.dateTimeEventPlanned,this.dateTimeUserConfirmedEvent,this.dateTimeSkippedEvent,this.customerNotes});
    CreateTreatmentScheduledEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateUserAuthDetails implements IReturn<IdResponse>, IPost, ICreateDb<UserAuthDetails>, IConvertible
{
    ...
    CreateUserAuthDetails({this.userAuthId,this.provider,this.userId,this.userName,this.fullName,this.displayName,this.firstName,this.lastName,this.company,this.email,this.phoneNumber,this.birthDate,this.birthDateRaw,this.address,this.address2,this.city,this.state,this.country,this.culture,this.gender,this.language,this.mailAddress,this.nickname,this.postalCode,this.timeZone,this.refreshToken,this.refreshTokenExpiry,this.requestToken,this.requestTokenSecret,this.items,this.accessToken,this.accessTokenSecret,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    CreateUserAuthDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class CreateUserAuthRole implements IReturn<IdResponse>, IPost, ICreateDb<UserAuthRole>, IConvertible
{
    ...
    CreateUserAuthRole({this.userAuthId,this.role,this.permission,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    CreateUserAuthRole.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteAppointments implements IReturn<IdResponse>, IDelete, IDeleteDb<Appointments>, IConvertible
{
    ...
    DeleteAppointments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteAppUser implements IReturn<IdResponse>, IDelete, IDeleteDb<AppUser>, IConvertible
{
    ...
    DeleteAppUser.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteCrudEvent implements IReturn<IdResponse>, IDelete, IDeleteDb<CrudEvent>, IConvertible
{
    ...
    DeleteCrudEvent.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteMeasurementDetails implements IReturn<IdResponse>, IDelete, IDeleteDb<MeasurementDetails>, IConvertible
{
    ...
    DeleteMeasurementDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteMeasurements implements IReturn<IdResponse>, IDelete, IDeleteDb<Measurements>, IConvertible
{
    ...
    DeleteMeasurements.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteMeasurementTypes implements IReturn<IdResponse>, IDelete, IDeleteDb<MeasurementTypes>, IConvertible
{
    ...
    DeleteMeasurementTypes.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteSchedules implements IReturn<IdResponse>, IDelete, IDeleteDb<Schedules>, IConvertible
{
    ...
    DeleteSchedules.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteTreatmentReminderSounds implements IReturn<IdResponse>, IDelete, IDeleteDb<TreatmentReminderSounds>, IConvertible
{
    String? id;

    DeleteTreatmentReminderSounds({this.id});
    DeleteTreatmentReminderSounds.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteTreatments implements IReturn<IdResponse>, IDelete, IDeleteDb<Treatments>, IConvertible
{
    ...
    DeleteTreatments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteTreatmentScheduledEvents implements IReturn<IdResponse>, IDelete, IDeleteDb<TreatmentScheduledEvents>, IConvertible
{
    String? id;

    DeleteTreatmentScheduledEvents({this.id});
    DeleteTreatmentScheduledEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteUserAuthDetails implements IReturn<IdResponse>, IDelete, IDeleteDb<UserAuthDetails>, IConvertible
{
    ...
    DeleteUserAuthDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class DeleteUserAuthRole implements IReturn<IdResponse>, IDelete, IDeleteDb<UserAuthRole>, IConvertible
{
    ...
    DeleteUserAuthRole.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchAppointments implements IReturn<IdResponse>, IPatch, IPatchDb<Appointments>, IConvertible
{
    ...
    PatchAppointments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.apptDateTime,this.place,this.placeNotes,this.providerName,this.appUserAuthId});
    PatchAppointments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchAppUser implements IReturn<IdResponse>, IPatch, IPatchDb<AppUser>, IConvertible
{
    ...
    PatchAppUser({this.profileUrl,this.lastLoginIp,this.lastLoginDate,this.id,this.userName,this.email,this.primaryEmail,this.phoneNumber,this.firstName,this.lastName,this.displayName,this.company,this.birthDate,this.birthDateRaw,this.address,this.address2,this.city,this.state,this.country,this.culture,this.fullName,this.gender,this.language,this.mailAddress,this.nickname,this.postalCode,this.timeZone,this.salt,this.passwordHash,this.digestHa1Hash,this.roles,this.permissions,this.createdDate,this.modifiedDate,this.invalidLoginAttempts,this.lastLoginAttempt,this.lockedDate,this.recoveryToken,this.refId,this.refIdStr,this.meta,this.appUserAuthId});
    PatchAppUser.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchCrudEvent implements IReturn<IdResponse>, IPatch, IPatchDb<CrudEvent>, IConvertible
{
    ...
    PatchCrudEvent({this.id,this.eventType,this.model,this.modelId,this.eventDate,this.rowsUpdated,this.requestType,this.requestBody,this.userAuthId,this.userAuthName,this.remoteIp,this.urn,this.refId,this.refIdStr,this.meta});
    PatchCrudEvent.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchMeasurementDetails implements IReturn<IdResponse>, IPatch, IPatchDb<MeasurementDetails>, IConvertible
{
    ...
    PatchMeasurementDetails({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.treatmentId,this.treatmentName,this.measurementTypeId,this.measurementTypeName,this.unitId,this.customerNotes,this.name});
    PatchMeasurementDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchMeasurements implements IReturn<IdResponse>, IPatch, IPatchDb<Measurements>, IConvertible
{
    ...
    PatchMeasurements({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentId,this.treatmentType});
    PatchMeasurements.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchMeasurementTypes implements IReturn<IdResponse>, IPatch, IPatchDb<MeasurementTypes>, IConvertible
{
    ...
    PatchMeasurementTypes({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentTypeId});
    PatchMeasurementTypes.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchSchedules implements IReturn<IdResponse>, IPatch, IPatchDb<Schedules>, IConvertible
{
    ...
    PatchSchedules({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.scheduleTime,this.startDate,this.endDate,this.treatmentId,this.treatmentName,this.isWeekendDifferent,this.appointmentId,this.treatmentUserId,this.lastRunTime,this.lastRunStatus,this.nextRunDateTime});
    PatchSchedules.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchTreatmentReminderSounds implements IReturn<IdResponse>, IPatch, IPatchDb<TreatmentReminderSounds>, IConvertible
{
    String? id;
    DateTime? createdAt;
    String? name;
    ...
    PatchTreatmentReminderSounds.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchTreatments implements IReturn<IdResponse>, IPatch, IPatchDb<Treatments>, IConvertible
{
    ...
    PatchTreatments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentType,this.appUserAuthId,this.unitsId,this.treatmentReminderSoundId,this.isMuted,this.dailyFrequency,this.measurementTypesId,this.measurementTypesName,this.unitsPlanned});
    PatchTreatments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchTreatmentScheduledEvents implements IReturn<IdResponse>, IPatch, IPatchDb<TreatmentScheduledEvents>, IConvertible
{
    String? id;
    DateTime? createdAt;
    DateTime? updatedAt;
    ...
    PatchTreatmentScheduledEvents({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.mood,this.scheduleId,this.treatmentId,this.treatmentName,this.treatmentUserId,this.treatmentUserName,this.treatmentDescription,this.completed,this.treatmentType,this.measurementTypeName,this.measurementId,this.measurementName,this.unitsPlanned,this.unitsTaken,this.unitTypesId,this.unitsTypeName,this.dateTimeEventPlanned,this.dateTimeUserConfirmedEvent,this.dateTimeSkippedEvent,this.customerNotes});
    PatchTreatmentScheduledEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchUserAuthDetails implements IReturn<IdResponse>, IPatch, IPatchDb<UserAuthDetails>, IConvertible
{
    ...
    PatchUserAuthDetails({this.id,this.userAuthId,this.provider,this.userId,this.userName,this.fullName,this.displayName,this.firstName,this.lastName,this.company,this.email,this.phoneNumber,this.birthDate,this.birthDateRaw,this.address,this.address2,this.city,this.state,this.country,this.culture,this.gender,this.language,this.mailAddress,this.nickname,this.postalCode,this.timeZone,this.refreshToken,this.refreshTokenExpiry,this.requestToken,this.requestTokenSecret,this.items,this.accessToken,this.accessTokenSecret,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    PatchUserAuthDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class PatchUserAuthRole implements IReturn<IdResponse>, IPatch, IPatchDb<UserAuthRole>, IConvertible
{
    ...
    PatchUserAuthRole({this.id,this.userAuthId,this.role,this.permission,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    PatchUserAuthRole.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateAppointments implements IReturn<IdResponse>, IPut, IUpdateDb<Appointments>, IConvertible
{
    ...
    UpdateAppointments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.apptDateTime,this.place,this.placeNotes,this.providerName,this.appUserAuthId});
    UpdateAppointments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateAppUser implements IReturn<IdResponse>, IPut, IUpdateDb<AppUser>, IConvertible
{
    ...
    UpdateAppUser({this.profileUrl,this.lastLoginIp,this.lastLoginDate,this.id,this.userName,this.email,this.primaryEmail,this.phoneNumber,this.firstName,this.lastName,this.displayName,this.company,this.birthDate,this.birthDateRaw,this.address,this.address2,this.city,this.state,this.country,this.culture,this.fullName,this.gender,this.language,this.mailAddress,this.nickname,this.postalCode,this.timeZone,this.salt,this.passwordHash,this.digestHa1Hash,this.roles,this.permissions,this.createdDate,this.modifiedDate,this.invalidLoginAttempts,this.lastLoginAttempt,this.lockedDate,this.recoveryToken,this.refId,this.refIdStr,this.meta,this.appUserAuthId});
    UpdateAppUser.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateCrudEvent implements IReturn<IdResponse>, IPut, IUpdateDb<CrudEvent>, IConvertible
{
    ...
    UpdateCrudEvent({this.id,this.eventType,this.model,this.modelId,this.eventDate,this.rowsUpdated,this.requestType,this.requestBody,this.userAuthId,this.userAuthName,this.remoteIp,this.urn,this.refId,this.refIdStr,this.meta});
    UpdateCrudEvent.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateMeasurementDetails implements IReturn<IdResponse>, IPut, IUpdateDb<MeasurementDetails>, IConvertible
{
    ...
    UpdateMeasurementDetails({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.treatmentId,this.treatmentName,this.measurementTypeId,this.measurementTypeName,this.unitId,this.customerNotes,this.name});
    UpdateMeasurementDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateMeasurements implements IReturn<IdResponse>, IPut, IUpdateDb<Measurements>, IConvertible
{
    ...
    UpdateMeasurements({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentId,this.treatmentType});
    UpdateMeasurements.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateMeasurementTypes implements IReturn<IdResponse>, IPut, IUpdateDb<MeasurementTypes>, IConvertible
{
    ...
    UpdateMeasurementTypes({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentTypeId});
    UpdateMeasurementTypes.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateSchedules implements IReturn<IdResponse>, IPut, IUpdateDb<Schedules>, IConvertible
{
    ...
    UpdateSchedules({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.scheduleTime,this.startDate,this.endDate,this.treatmentId,this.treatmentName,this.isWeekendDifferent,this.appointmentId,this.treatmentUserId,this.lastRunTime,this.lastRunStatus,this.nextRunDateTime});
    UpdateSchedules.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateTreatmentReminderSounds implements IReturn<IdResponse>, IPut, IUpdateDb<TreatmentReminderSounds>, IConvertible
{
    String? id;
    DateTime? createdAt;
    String? name;
    ...
    UpdateTreatmentReminderSounds.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateTreatments implements IReturn<IdResponse>, IPut, IUpdateDb<Treatments>, IConvertible
{
    ...
    UpdateTreatments({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.name,this.description,this.treatmentType,this.appUserAuthId,this.unitsId,this.treatmentReminderSoundId,this.isMuted,this.dailyFrequency,this.measurementTypesId,this.measurementTypesName,this.unitsPlanned});
    UpdateTreatments.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateTreatmentScheduledEvents implements IReturn<IdResponse>, IPut, IUpdateDb<TreatmentScheduledEvents>, IConvertible
{
    String? id;
    DateTime? createdAt;
    DateTime? updatedAt;
    ...
    UpdateTreatmentScheduledEvents({this.id,this.createdAt,this.updatedAt,this.deletedAt,this.mood,this.scheduleId,this.treatmentId,this.treatmentName,this.treatmentUserId,this.treatmentUserName,this.treatmentDescription,this.completed,this.treatmentType,this.measurementTypeName,this.measurementId,this.measurementName,this.unitsPlanned,this.unitsTaken,this.unitTypesId,this.unitsTypeName,this.dateTimeEventPlanned,this.dateTimeUserConfirmedEvent,this.dateTimeSkippedEvent,this.customerNotes});
    UpdateTreatmentScheduledEvents.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateUserAuthDetails implements IReturn<IdResponse>, IPut, IUpdateDb<UserAuthDetails>, IConvertible
{
    ...
    UpdateUserAuthDetails({this.id,this.userAuthId,this.provider,this.userId,this.userName,this.fullName,this.displayName,this.firstName,this.lastName,this.company,this.email,this.phoneNumber,this.birthDate,this.birthDateRaw,this.address,this.address2,this.city,this.state,this.country,this.culture,this.gender,this.language,this.mailAddress,this.nickname,this.postalCode,this.timeZone,this.refreshToken,this.refreshTokenExpiry,this.requestToken,this.requestTokenSecret,this.items,this.accessToken,this.accessTokenSecret,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    UpdateUserAuthDetails.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
class UpdateUserAuthRole implements IReturn<IdResponse>, IPut, IUpdateDb<UserAuthRole>, IConvertible
{
    ...
    UpdateUserAuthRole({this.id,this.userAuthId,this.role,this.permission,this.createdDate,this.modifiedDate,this.refId,this.refIdStr,this.meta});
    UpdateUserAuthRole.fromJson(Map<String, dynamic> json) { fromMap(json); }
...
TypeContext _ctx = TypeContext(library: 'localhost', types: <String, TypeInfo> {
    ...
    'QueryResponse<TreatmentReminderSounds>': TypeInfo(TypeOf.Class, create:() => QueryResponse<TreatmentReminderSounds>()),
    ...
    'QueryResponse<TreatmentScheduledEvents>': TypeInfo(TypeOf.Class, create:() => QueryResponse<TreatmentScheduledEvents>()),
