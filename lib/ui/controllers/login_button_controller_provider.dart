...
// class LoginButton extends ConsumerWidget<RaisedButton> {
//   @override
...
//     );
//     final loginStateLoading = ref.watch(loginButtonControllerProvider);

//     // note: this is a *custom* button class that takes an extra `isLoading` argument
//     return LoginButton(
//       text: 'Login',
//       // show a spinner if loading is true
//       isLoading: loginStateLoading..isLoading,
...
//   loginButtonController({this.ref}): super(const AsyncValue.data(null));
...
//   static void add(AuthenticationStatus authenticationStatus) {
//     InMemoryStore.add(authenticationStatus);
//   }
...
// enum AuthenticationStatus { unknown, isLoading, authenticated, unauthenticated, error }
...
// final authStateNotifierProvider = StateNotifierProvider<AsyncValue<void>((ref) => AuthStateNotifier(ref));
